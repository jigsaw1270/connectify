  ...
  return (
    <nav className='leftsidebar'>
      ...
      <Link to="/" className='flex items-center gap-3'>
                <img src='/assets/images/connectify.png' alt='logo' width={170} height={36}/>
            </Link>

            <Link to={`/profile/${user.id}`} className='flex items-center gap-3'>
              <img src={user.imageUrl || "/assets/icons/profile-placeholder.svg"} alt="profile" className='rounded-full h-14 w-14' />
